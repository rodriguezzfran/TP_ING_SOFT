...
public class Constants {
    ...
    public static class UI{
        ...
        public static class PauseButtons {
            ...
            public static final int SOUND_SIZE = (int) (SOUND_SIZE_DEFAULT * Game.SCALE)-20;
        }
        ...
        public static class VolumeButtons {
            ...
            public static final int VOLUME_WIDTH = (int) (VOLUME_DEFAULT_WIDTH * Game.SCALE-15);
            public static final int VOLUME_HEIGHT = (int) (VOLUME_DEFAULT_HEIGHT * Game.SCALE -30);
            public static final int SLIDER_WIDTH = (int) (SLIDER_DEFAULT_WIDTH * Game.SCALE -130);
        }
    }
